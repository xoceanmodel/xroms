...
def uv_geostrophic(zeta, f, grid, hboundary='extend', hfill_value=None, which='both'):
    ...
    if which in ['both','xi']:
        ...
        ug = -g*dzetadxi/xroms.to_u(f, grid, hboundary=hboundary, hfill_value=hfill_value)
    ...
    if which in ['both','eta']:
        ...
        # calculate geostrophic velocities
        vg = g*dzetadeta/xroms.to_v(f, grid, hboundary=hboundary, hfill_value=hfill_value)
...
def relative_vorticity(u, v, grid, hboundary='extend', hfill_value=None, sboundary='extend', sfill_value=None):
    ...
    dvdxi = xroms.hgrad(v, grid, which='xi', hboundary=hboundary, hfill_value=hfill_value, 
                        sboundary=sboundary, sfill_value=sfill_value)
    dudeta = xroms.hgrad(u, grid, which='eta', hboundary=hboundary, hfill_value=hfill_value, 
                         sboundary=sboundary, sfill_value=sfill_value)
...
def ertel(phi, u, v, f, grid, hcoord='rho', scoord='s_rho',
    ...
    phi_xi, phi_eta = xroms.hgrad(phi, grid, hboundary=hboundary, hfill_value=hfill_value, 
                                  sboundary=sboundary, sfill_value=sfill_value)
    ...
    phi_eta = xroms.to_grid(phi_eta, grid, hcoord=hcoord, scoord=scoord, 
                           hboundary=hboundary, hfill_value=hfill_value, 
                           sboundary=sboundary, sfill_value=sfill_value)
    phi_z = xroms.ddz(phi, grid, hcoord=hcoord, scoord=scoord,
                      hboundary=hboundary, hfill_value=hfill_value,
                      sboundary=sboundary, sfill_value=sfill_value)

    # vertical shear (horizontal components of vorticity)
    u_z = xroms.ddz(u, grid, hcoord=hcoord, scoord=scoord, 
                    hboundary=hboundary, hfill_value=hfill_value,
                    sboundary=sboundary, sfill_value=sfill_value)
    v_z = xroms.ddz(v, grid, hcoord=hcoord, scoord=scoord,
                    hboundary=hboundary, hfill_value=hfill_value,
                    sboundary=sboundary, sfill_value=sfill_value)

    # vertical component of vorticity
    vort = relative_vorticity(u, v, grid, hboundary=hboundary, hfill_value=hfill_value, 
                              sboundary=sboundary, sfill_value=sfill_value)
    vort = xroms.to_grid(vort, grid, hcoord=hcoord, scoord=scoord,
                         hboundary=hboundary, hfill_value=hfill_value,
                         sboundary=sboundary, sfill_value=sfill_value)
