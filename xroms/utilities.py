...
def hgrad(q, grid, which='both', z=None, hcoord=None, scoord=None, 
          hboundary='extend', hfill_value=None, sboundary='extend', sfill_value=None, attrs=None):
...
def ddxi(var, grid, z=None, hcoord=None, scoord=None, hboundary='extend', hfill_value=np.nan, 
         sboundary='extend', sfill_value=np.nan, attrs=None):
    ...
    var = xroms.hgrad(var, grid, which='xi', z=z, hcoord=hcoord, scoord=scoord, 
                      hboundary=hboundary, hfill_value=hfill_value, 
                      sboundary=sboundary, sfill_value=sfill_value, attrs=attrs)
    return var


def ddeta(var, grid, z=None, hcoord=None, scoord=None, hboundary='extend', hfill_value=np.nan, 
          sboundary='extend', sfill_value=np.nan, attrs=None):
    ...
    var = xroms.hgrad(var, grid, which='eta', z=z, hcoord=hcoord, scoord=scoord, 
                      hboundary=hboundary, hfill_value=hfill_value, 
                      sboundary=sboundary, sfill_value=sfill_value, attrs=attrs)
    return var


def ddz(var, grid, hcoord=None, scoord=None, hboundary='extend', hfill_value=None, 
...
def to_rho(var, grid, hboundary='extend', hfill_value=None):
    ...
    if 'xi_rho' not in var.dims:
        var = grid.interp(var, 'X', to='center', boundary=hboundary, fill_value=hfill_value)
    if 'eta_rho' not in var.dims:
        var = grid.interp(var, 'Y', to='center', boundary=hboundary, fill_value=hfill_value)
    return var
...
def to_psi(var, grid, hboundary='extend', hfill_value=None):
    ...
    if 'xi_u' not in var.dims:
        var = grid.interp(var, 'X', to='inner', boundary=hboundary, fill_value=hfill_value)
    if 'eta_v' not in var.dims:
        var = grid.interp(var, 'Y', to='inner', boundary=hboundary, fill_value=hfill_value)
    return var
...
def to_s_rho(var, grid, sboundary='extend', sfill_value=None):
    ...
    if 's_rho' not in var.dims:
        var = grid.interp(var, 'Z', to='center', boundary=sboundary, fill_value=sfill_value)
    return var
...
def to_s_w(var, grid, sboundary='extend', sfill_value=None):
    ...
    if 's_w' not in var.dims:
        var = grid.interp(var, 'Z', to='outer', boundary=sboundary, fill_value=sfill_value)
    return var


def to_grid(var, grid, hcoord=None, scoord=None, hboundary='extend', hfill_value=None, 
            sboundary='extend', sfill_value=None, attrs=None):
